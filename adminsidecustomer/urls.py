...
url(r'^suspend_warning/(?P<pk>[0-9]+)$', customer_views.send_suspend_warning, name='send_suspend_warning'),
url(r'^suspend_warning_sms/(?P<pk>[0-9]+)$', customer_views.send_suspend_warning_sms, name='send_suspend_warning_sms'),
