...
def create_tickets(request,id):
    if request.method == 'GET':
        ...
        return render(request, 'admin/customer/create_tickets.html', {'id': id,'customer_plan_data':customer_plan_data,'ticket_category':ticket_category,'uploaduser':uploaduser})
    if request.method == 'POST':
