...
def edit(request,id):
 if  request.method == 'GET':
     customer_data = Customer.objects.values('id',
                                             'account_id',
                                             'status',
                                             'first_name',
                                             'first_name_gsr',
     ...
     account_address = AccountAddressCustomer.objects.values(
                                           'address_1',
                                           'address_2',
                                           'city_id',
                                           'province_id',
     ...
     billing_address = BillingAddressCustomer.objects.values(
                                           'billing_address_1',
                                           'billing_address_2',
                                           'billing_city_id',
                                           'billing_province_id',
     ...
     billing_details = BillingDetailsCustomer.objects.values(
                                           'salesperson_id',
                                           'contract_type',
                                           'billing_day',
                                           'payment_mode',
