...
def settings_logins_add(request):
    if request.method == 'GET':
        return render(request, 'agent/settings/logins/add.html')
...
def settings_logins_edit(request,pk):
    if request.method == 'GET':
        ...
        return render(request, 'agent/settings/logins/edit.html',{'pk':pk,'userdetails':userdetails})
        ...
        try:
            ...
            try:
                ...
                return HttpResponseRedirect(reverse('agent_settings_logins_edit', kwargs={'pk': pk}))
