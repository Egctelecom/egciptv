...
from adminsideserviceprovider.models import CustomerTicketsCategoriesMap, TicketsCategories, ServiceProvider
...
def ticket_list(request):
    if request.method == 'GET':
        ...
        providers = ServiceProvider.objects.values('id', 'service_provider_name')
        for i in providers:
            tickets_count = CustomerTicketsCategoriesMap.objects.filter(service_provider__id=i['id']).count()
            i['ticket_count'] = tickets_count
